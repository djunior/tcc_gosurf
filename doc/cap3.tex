...
\paragraph{}O pré-processamento inicia a partir do vídeo capturado de uma praia. Cada \textit{frame} do vídeo é processado, primeiro convertendo o \textit{frame} para uma imagem em níveis de cinza, pois todos os processamentos posteriores só operam sobre o nível de intensidade de cada \textit{pixel}. A seguir, equaliza-se o histograma do \textit{frame}, a fim de minimizar a variação da iluminação na imagem. Este passo deve ser realizado em cada frame pois com vídeo longos a iluminação pode mudar consideravelmente do começo até o final do vídeo.
