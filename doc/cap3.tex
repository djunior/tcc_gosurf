...
\paragraph{}A figura \ref{FigHistogramSunny} ilustra o efeito da equalização de histograma sobre uma imagem de alta luminosidade, enquanto a figura \ref{FigHistogramCloud} ilustra o efeito da equalização de histograma em um dia de baixa luminosidade (um dia nublado). Nota-se que o histograma do dia com baixa luminosidade apresenta uma grande concentração de pixels nos níveis de maior intensidade, enquanto o histograma do dia com alta luminosidade está melhor distribuído por todo o espectro de níveis de cinza. Com isso, pode-se notar que o efeito da equalização foi mais significativo na figura \ref{FigHistogramCloud}.

\begin{figure}[h]
  \centering
  \subfloat[\small{Imagem de uma praia em dia ensolarado (alta luminosidade).}]{\includegraphics[width=.45\textwidth,height=.15\textheight]{sunny_grey_image.jpg}}
  \qquad
  \subfloat[\small{Histograma da imagem original.}]{\includegraphics[width=.3\textwidth,height=.15\textheight]{sunny_histogram.jpg}}
  \qquad
  \subfloat[\small{Resultado da equalização da imagem original.}]{\includegraphics[width=.45\textwidth,height=.15\textheight]{sunny_equalized_image.jpg}}
  \qquad
  \subfloat[\small{Histograma da imagem equalizada.}]{\includegraphics[width=.3\textwidth,height=.15\textheight]{sunny_histogram_eq.jpg}}
  ...
  \label{FigHistogramSunny}
\end{figure}

\begin{figure}[h]
  \centering
  \subfloat[\small{Imagem de uma praia em dia nublado (baixa luminosidade).}]{\includegraphics[width=.45\textwidth,height=.15\textheight]{cloud_grey_image.jpg}}
  \qquad
  \subfloat[\small{Histograma da imagem original.}]{\includegraphics[width=.3\textwidth,height=.15\textheight]{cloud_histogram.jpg}}
  \qquad
  \subfloat[\small{Resultado da equalização da imagem original.}]{\includegraphics[width=.45\textwidth,height=.15\textheight]{cloud_equalized_image.jpg}}
  \qquad
  \subfloat[\small{Histograma da imagem equalizada.}]{\includegraphics[width=.3\textwidth,height=.15\textheight]{cloud_histogram_eq.jpg}}
  \caption[\small{Comparação entre o histograma original e equalizado de um dia nublado.}]{\small{Comparação entre o histograma original e equalizado de um dia nublado.}}
  \label{FigHistogramCloud}
\end{figure}

\paragraph{}As figuras \ref{FigHistogramSunny}c e \ref{FigHistogramCloud}c exibem o efeito de normalização da luminosidade no vídeo. Estas as imagens equalizadas serão utilizadas pelos próximos passos do pré-processamento para gerar o \textit{timestack}. A equalização de histograma é realizada através da biblioteca de processamento gráfico OpenCV, e será discutida com mais detalhes no Capítulo 4.
