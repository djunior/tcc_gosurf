...
\end{figure}
\todo{Corrigir diagrama da classe Point e adicionar classe Derivable}
...
\lstinputlisting[linerange=analyseTrajectoryBegin-analyseTrajectoryEnd]{../src/lib/waveDetector.cpp}
...
\todo{Corrigir a função calculateRealHeight e adicionar texto explicando porque imageHeight - pixelTop }
