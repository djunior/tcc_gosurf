...
\paragraph{}Nos 4 dias em que os vídeos foram capturados, 9 vídeos foram descartados por apresentarem problemas impeditivos, em geral interferência humana. Um quinto dia (01/07/2017) teve todos os seus vídeos descartados por baixa iluminação. Os vídeos descartados não foram contabilizados nos resultados.
...
\paragraph{}Por fim, a tabela \ref{TabConfusionMatrix} apresenta a matrix de confusão contendo dados de todos os vídeos analisados. Os dados derivados da matrix de confusão estão apresentados na tabela \ref{TabConfusionData}. Estes dados demonstram que o algoritmo consegue identificar corretamente as ondas do mar com uma taxa de 84.25\% e consegue rejeitar não-ondas com uma taxa de 66.67\%, resultando em uma eficiência de 75.46\%. O algoritmo gera poucos falso-positivos, com uma taxa de precisão de 91.24\%, embora tenha a tendência a não indentificar ondas reais com uma taxa de predição negativa de 50.66\%. A acurácia do algoritmo é de 80.82\%.

\begin{table}
    \centering
    \input{../analysed_waves_otsu/confusion_matrix.tex}
    \caption[\small{Matrix de confusão dos vídeos analisados.}]{\small{Matrix de confusão dos vídeos analisados.}}
